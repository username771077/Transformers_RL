...
obs_shape = env.observation_space.shape if hasattr(env.observation_space, 'shape') else ()
action_dtype = np.int64

with h5py.File('Blackjack-v5.h5', 'w') as f:
    ...
    def flush_to_disk():
        ...
        observations_arr = np.array(buffer_observations, dtype=np.int64)

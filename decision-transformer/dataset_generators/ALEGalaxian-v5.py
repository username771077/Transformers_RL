...
with h5py.File('Galaxian-v5.h5', 'w') as f:
    d_actions = f.create_dataset(
        'actions', 
        shape=(0,), 
        maxshape=(None,), 
        dtype=action_dtype,
    ...
    d_observations = f.create_dataset(
        'observations', 
        shape=(0,)+obs_shape, 
